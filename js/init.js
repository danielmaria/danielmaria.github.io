...
function putTextInLabels(){
  ...
  if(lang === "PT"){
    ...
    aboutMe = "I am a backend in my profession and a frontend by hobby. I am completly addicted in software development. Daily in my job, I use Java (JSF, RichFaces, JSP, Servlets, Hibernate, Spring) and Oracle for database. Despite this, I like a lot of others technologies. For fun, I like to learn NodeJS, Vanilla JavaScript and JQuery, MongoDB, etc.";
    ...
    downloadText = "If you want, you can make a download of my curriculum vitae or resume:";
  }
