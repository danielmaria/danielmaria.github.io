...
function putTextInLabels(lang){
  ...
  function changeTo(lang) {
    ...
    document.getElementById("conterCourses").hidden = false;
    document.getElementById("btnShowAllClasses").hidden = false;
  }
...
"<b>  Outsourcing Sicredi (banking sector):</b>"  +
  ...
  "<b>Outsourcing Sicredi (setor bancário):</b> " + 
    ...
    "<li> Uso do JIRA para controle de demandas e progresso e o Confluence como base de conhecimento;</li>" +
  ...
  "<div style='padding: 0 1em;'>" + 
  "<li>Analisar, desenvolver e manutenção de aplicações Java (JPA [Hibernate], EJB, JSF, RichFaces, Spring Framework, Servlets e JSP) usando como base de dados Oracle, JBoss e Tomcat como servidor, e SVN como ferramenta de versionamento;</li>" +
  "<li>Analisar, desenvolver e manter rotinas de banco de dados com Oracle PL/SQL;</li>" +
  "<li>Criar e executar casos de teste com JUnit para testes unitários.</li>" +
  "</div>";